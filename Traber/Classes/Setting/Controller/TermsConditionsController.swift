...
class TermsConditionsController: AntController,UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let shareUrl = "http://www.ticketez.com/FrontendWeb/home/?token=" + AntManage.userModel!.token + "&identity=" + AntManage.userModel!.identity + "&redirecturl=terms&source=home&noheader=1"
